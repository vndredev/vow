...
test("documentSymbols returns a file's real symbol tree (the spawned LSP server)", async () => {
...
test("findReferences resolves a symbol's real uses across files (not text matches)", async () => {
