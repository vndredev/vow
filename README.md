...
> **Foundation phase.** The core mechanism works end-to-end (entity · view · bind · primitives · scenario-coverage · local-state CRUD). The surface — more field types, the primitive ladder, patterns, layout, persistence, and an MCP server — grows slowly, element by element. See the [roadmap](./docs/guide/roadmap.md).
